...
describe ComponentModel do
  ...
  it "should enforce validations" do
    ...
    model1     = FactoryGirl.build(:component_model, name: nil, brand: brand1)
  ...
  it "should work" do
    ...
    # since we have 1 checkoutable kit for model1, ComponentModel.checkoutable should return 1
    checkoutable_models = ComponentModel.checkoutable
